...
public class BlockTags extends FabricTagProvider.BlockTagProvider
{
	...
	protected void registerModTags() {
		getOrCreateTagBuilder(ModTags.TERRAIN).forceAddTag(net.minecraft.tags.BlockTags.DIRT).forceAddTag(net.minecraft.tags.BlockTags.SAND);
		...
		getOrCreateTagBuilder(ModTags.UNAFFECTED_BY_RICH_SOIL).add(
						...
						ModBlocks.BROWN_MUSHROOM_COLONY.get(),
						ModBlocks.RED_MUSHROOM_COLONY.get())
				.forceAddTag(ModTags.WILD_CROPS).forceAddTag(net.minecraft.tags.BlockTags.TALL_FLOWERS);
