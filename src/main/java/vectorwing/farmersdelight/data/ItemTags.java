...
public class ItemTags extends FabricTagProvider.ItemTagProvider
{
	...
	private void registerModTags() {
		...
		tagBuilder(ModTags.Items.KNIVES).add(ModItems.FLINT_KNIFE.get(), ModItems.COPPER_KNIFE.get(), ModItems.IRON_KNIFE.get(), ModItems.DIAMOND_KNIFE.get(), ModItems.GOLDEN_KNIFE.get(), ModItems.NETHERITE_KNIFE.get());
...
//		tagBuilder(CommonTags.Items.FOODS_SAFE_RAW_FISH).addTag(ConventionalItemTags.RAW_FISH_FOODS).remove(Items.PUFFERFISH);
		...
		tagBuilder(CommonTags.Items.TOOLS_KNIFE).add(ModItems.FLINT_KNIFE.get(), ModItems.COPPER_KNIFE.get(), ModItems.IRON_KNIFE.get(), ModItems.DIAMOND_KNIFE.get(), ModItems.GOLDEN_KNIFE.get(), ModItems.NETHERITE_KNIFE.get());
	}
