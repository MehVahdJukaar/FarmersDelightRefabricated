...
public class ItemTags extends FabricTagProvider.ItemTagProvider
{
	...
	private void registerMinecraftTags() {
        ...
        tagBuilder(net.minecraft.tags.ItemTags.SWORD_ENCHANTABLE).addTag(ModTags.Items.KNIVES).add(ModItems.SKILLET.get());
	...
	private void registerNeoForgeTags() {
		...
		tagBuilder(ConventionalTags.DRINKS_MILK).add(ModItems.MILK_BOTTLE.get());
		...
		tag(ConventionalItemTags.DOUGH_FOODS).addTag(CommonTags.Items.FOODS_DOUGH_WHEAT);
