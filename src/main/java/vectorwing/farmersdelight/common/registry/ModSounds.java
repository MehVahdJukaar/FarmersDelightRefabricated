...
{
	public static final LazyRegistrar<SoundEvent> SOUNDS = LazyRegistrar.create(Registries.SOUND_EVENT, FarmersDelight.MODID);
	...
	public static final Supplier<SoundEvent> BLOCK_TOMATOES_PICK_TOMATOES = SOUNDS.register("block.tomatoes.pick_tomatoes",
			() -> SoundEvent.createVariableRangeEvent(new ResourceLocation(FarmersDelight.MODID, "block.tomatoes.pick_tomatoes")));
	...
	public static final Supplier<SoundEvent> BLOCK_FOOD_SLICE = SOUNDS.register("block.food.slice",
			() -> SoundEvent.createVariableRangeEvent(new ResourceLocation(FarmersDelight.MODID, "block.food.slice")));
