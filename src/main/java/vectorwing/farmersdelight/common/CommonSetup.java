...
public class CommonSetup
{
	...
	public static void registerItemSetAdditions() {
		...
		Chicken.FOOD_ITEMS = DefaultCustomIngredients.any(Chicken.FOOD_ITEMS, newChickenFood);

		Ingredient newPigFood = Ingredient.of(ModItems.CABBAGE.get(), ModItems.TOMATO.get());
		Pig.FOOD_ITEMS = DefaultCustomIngredients.any(Pig.FOOD_ITEMS, newPigFood);

		Ingredient newCatFood = Ingredient.of(ModItems.COD_SLICE.get(), ModItems.SALMON_SLICE.get());
		Cat.TEMPT_INGREDIENT = DefaultCustomIngredients.any(Cat.TEMPT_INGREDIENT, newCatFood);
