...
public class Configuration
{
	...
	public static ModConfigSpec.BooleanValue ENABLE_RABBIT_STEW_JUMP_BOOST;
	...
	public static ModConfigSpec.BooleanValue FARMERS_BUY_FD_CROPS = ENABLE_FARMERS_BUY_FD_CROPS;
	@Deprecated(forRemoval = true)
	public static ModConfigSpec.BooleanValue WANDERING_TRADER_SELLS_FD_ITEMS = ENABLE_WANDERING_TRADER_SELLS_FD_ITEMS;
	@Deprecated(forRemoval = true)
	public static ModConfigSpec.BooleanValue ENABLE_RECIPE_BOOK_COOKING_POT = ENABLE_COOKING_POT_RECIPE_BOOK;
	@Deprecated(forRemoval = true)
	public static ModConfigSpec.BooleanValue VANILLA_SOUP_EXTRA_EFFECTS = ENABLE_VANILLA_SOUP_EXTRA_EFFECTS;
	@Deprecated(forRemoval = true)
	public static ModConfigSpec.BooleanValue RABBIT_STEW_JUMP_BOOST = ENABLE_RABBIT_STEW_JUMP_BOOST;
	@Deprecated(forRemoval = true)
	public static ModConfigSpec.BooleanValue DISPENSER_TOOLS_CUTTING_BOARD = ENABLE_DISPENSER_TOOLS_CUTTING_BOARD;
	@Deprecated(forRemoval = true)
	public static ModConfigSpec.BooleanValue NOURISHMENT_HUNGER_OVERLAY = ENABLE_NOURISHMENT_HUNGER_OVERLAY;
	@Deprecated(forRemoval = true)
