...
public class VillageStructures
{
    ...
    public static void addNewVillageBuilding(MinecraftServer server) {
        if (Configuration.GENERATE_VILLAGE_COMPOST_HEAPS.get()) {
            Registry<StructureTemplatePool> templatePools = server.registryAccess().registryOrThrow(Registries.TEMPLATE_POOL);
            Registry<StructureProcessorList> processorLists = server.registryAccess().registryOrThrow(Registries.PROCESSOR_LIST);
