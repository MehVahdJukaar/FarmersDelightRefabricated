...
public class EnumParameters
{
	...
	public static final EnumProxy<HumanoidModel.ArmPose> PROXY_SKILLET_FLIP = new EnumProxy<>(
		HumanoidModel.ArmPose.class, false, new ModArmPoses.SkilletArmPose()
	);
	public static final EnumProxy<HumanoidModel.ArmPose> PROXY_HAND_COOKING = new EnumProxy<>(
		HumanoidModel.ArmPose.class, false, new ModArmPoses.HandCookingArmPose()
	);
	*/
}
