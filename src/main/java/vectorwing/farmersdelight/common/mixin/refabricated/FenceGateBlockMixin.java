...
public class FenceGateBlockMixin {
	@ModifyExpressionValue(method = "useWithoutItem", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/level/block/state/properties/WoodType;fenceGateOpen()Lnet/minecraft/sounds/SoundEvent;"))
	...
	@ModifyExpressionValue(method = "useWithoutItem", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/level/block/state/properties/WoodType;fenceGateClose()Lnet/minecraft/sounds/SoundEvent;"))
	...
	@ModifyExpressionValue(method = "onExplosionHit", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/level/block/state/properties/WoodType;fenceGateOpen()Lnet/minecraft/sounds/SoundEvent;"))
	private SoundEvent fdrf$modifyOnExplosionHitOpenSound(SoundEvent original) {
		if ((FenceGateBlock) (Object) this instanceof RopeFenceGateBlock) {
			return ModSounds.BLOCK_ROPE_FENCE_GATE_OPEN.get();
		}
		return original;
